...
const cards = [
  { text: 'Você trocou a cor do botão.',      icon: '/image_6.webp',  bg: 'bg-[#f1eddf]', rotate: '-rotate-2' },
  { text: 'Mudou a headline',                  icon: '/image_7.webp',  bg: 'bg-white',     rotate: 'rotate-2'  },
  { text: 'Publicou no grupo do Discord.',      icon: '/image_8.webp',  bg: 'bg-[#f1eddf]', rotate: '-rotate-2' },
  { text: 'Pediu feedback no X/Twitter.',       icon: '/image_9.webp',  bg: 'bg-white',     rotate: 'rotate-2'  },
  { text: 'Os amigos testaram. Funciona.',      icon: '/image_10.webp', bg: 'bg-[#f1eddf]', rotate: '-rotate-2' },
    ...
    <section className="bg-[#fbf9f2] px-5 sm:px-8 lg:px-[156px] py-24">
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:sticky lg:top-28 lg:self-start lg:w-[552px] shrink-0">
          <h2 className="font-['Archivo',sans-serif] font-medium text-[32px] lg:text-[40px] leading-[120%] tracking-[-1.5px] lg:tracking-[-2px]">
            <span className="text-nav-text">
              Você abriu o{' '}
              <img src="/image_5.webp" alt="" className="inline-block size-12 lg:size-16 align-middle" />
              {' '}analytics hoje.
            </span>
            <br />
        ...
        <div className="w-full lg:w-[552px]">
              ...
              >
                <div className={rotate}>
                  <div className={`${bg} flex gap-4 items-center p-6 rounded-2xl w-full lg:w-[428px]`}>
                    ...
                    <p className="font-['Archivo',sans-serif] font-medium text-[20px] lg:text-[24px] leading-[120%] tracking-[-0.72px] text-[#1c1917]">
                      {text}
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-3xl pl-8 pr-12 py-8 flex gap-4 items-center">
            <img src="/image12.webp" alt="" className="size-[120px] shrink-0 object-contain" />
            <p className="font-['Archivo',sans-serif] font-medium text-[18px] lg:text-[20px] leading-[130%] tracking-[-0.6px] text-[#1c1917]">
